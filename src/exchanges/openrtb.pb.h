...
class BidRequest_Imp_Video : public ::google::protobuf::Message {
 public:
  ...
  bool has_protocol() const PROTOBUF_DEPRECATED;
  void clear_protocol() PROTOBUF_DEPRECATED;
  static const int kProtocolFieldNumber = 5;
  ::com::google::openrtb::BidRequest_Imp_Video_VideoBidResponseProtocol protocol() const PROTOBUF_DEPRECATED;
  void set_protocol(::com::google::openrtb::BidRequest_Imp_Video_VideoBidResponseProtocol value) PROTOBUF_DEPRECATED;
  ...
  bool has_companionad_21() const PROTOBUF_DEPRECATED;
  void clear_companionad_21() PROTOBUF_DEPRECATED;
  static const int kCompanionad21FieldNumber = 22;
  const ::com::google::openrtb::BidRequest_Imp_Video_CompanionAd& companionad_21() const PROTOBUF_DEPRECATED;
  ::com::google::openrtb::BidRequest_Imp_Video_CompanionAd* mutable_companionad_21() PROTOBUF_DEPRECATED;
  ::com::google::openrtb::BidRequest_Imp_Video_CompanionAd* release_companionad_21() PROTOBUF_DEPRECATED;
  void set_allocated_companionad_21(::com::google::openrtb::BidRequest_Imp_Video_CompanionAd* companionad_21) PROTOBUF_DEPRECATED;
